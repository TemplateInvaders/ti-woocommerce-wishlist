...
class TInvWL_Wizard {
	...
	function enqueue_styles() {
		...
		wp_enqueue_style( $this->_n . '-setup', TINVWL_URL . 'asset/css/admin-setup.css', array( 'dashicons', 'install' ), $this->_v, 'all' );
	...
	function wizard_1() {
		...
		$data = array(
			'general_default_title_value'	 => tinv_get_option( 'general', 'default_title' ),
		);
