...
<div class="tinwl-inner tinwl-finish">
	...
	<div class="tinvwl-desc">
		<?php printf( esc_html__( 'You have set basic Wishlist settings. If you want to make a more in-depth plugin setup you can make it on the plugin settings page %s.', 'ti-woocommerce-wishlist' ), sprintf( '<a target="_blank" href="%s">%s</a>', esc_url( TInvWL_View::admin_url( '' ) ), esc_html__( 'WooCommerce Wishlist Plugin Settings', 'ti-woocommerce-wishlist' ) ) ); // WPCS: xss ok. ?>
		<br/>
	...
	<a class="tinvwl-btn grey w-icon xl-icon round" href="<?php echo esc_url( TInvWL_View::admin_url( '' ) ); ?>"><i
